    ...
    return(
        <nav className="navegacionPrincipal">
            ...
            <div className="enlacesCarrito">
                <Link to="/" className="enlaceInicioContacto">Inicio</Link>
                <Link to="/" className="enlaceInicioContacto">Contacto</Link>
                <NavLink className={({isActive})=>isActive === true ? "claseActiva" : "claseInactiva"} to="/category/accesorios">Accesorios</NavLink>
                <NavLink className={({isActive})=>isActive === true ? "claseActiva" : "claseInactiva"} to="/category/herramientas">Herramientas</NavLink>
                <NavLink className={({isActive})=>isActive === true ? "claseActiva" : "claseInactiva"} to="/category/insumos">Insumos</NavLink>
